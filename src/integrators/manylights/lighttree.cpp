...
std::vector<VPL> LightTree::getClusteringForPoint(Intersection its, std::uint32_t max_lights, float error_threshold) {
	...
	std::priority_queue<ClusterAndScore, std::vector<ClusterAndScore>, decltype(comparator)> pqueue;
