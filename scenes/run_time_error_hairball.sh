...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=0.025 -Dcompcstrat=mdlc -Dcps=500 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=0.025 -Dcompcstrat=mdlc -Dcps=1000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=0.025 -Dcompcstrat=mdlc -Dcps=2000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=0.025 -Dcompcstrat=mdlc -Dcps=4000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=0.025 -Dcompcstrat=mdlc -Dcps=8000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=mdlc -Dcps=250 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=mdlc -Dcps=500 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=mdlc -Dcps=1000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=mdlc -Dcps=2000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=mdlc -Dcps=4000 -Dsps=1 -Dspp=4 -Dslice=1000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=250 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=500 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=1000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=2000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
# for i in {1..5}
# do
# 	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=3 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=4000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0
...
for i in {1..5}
do
	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=5 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=250 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0.1
	python3 "${source_dir}/../compare_err.py" "${source_dir}/hairball/hairball.exr" "${source_dir}/hairball/groundtruth.exr" "${source_dir}/hairball/hairball_ic_01"
done
mv "${source_dir}/hairball/timings" "${source_dir}/hairball/timings_ic_01"
mv "${source_dir}/hairball/samplerates" "${source_dir}/hairball/samplerates_ic_01"

for i in {1..5}
do
	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=5 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=500 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0.05
	python3 "${source_dir}/../compare_err.py" "${source_dir}/hairball/hairball.exr" "${source_dir}/hairball/groundtruth.exr" "${source_dir}/hairball/hairball_ic_005"
done
mv "${source_dir}/hairball/timings" "${source_dir}/hairball/timings_ic_005"
mv "${source_dir}/hairball/samplerates" "${source_dir}/hairball/samplerates_ic_005"

for i in {1..5}
do
	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=5 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=1000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0.02
	python3 "${source_dir}/../compare_err.py" "${source_dir}/hairball/hairball.exr" "${source_dir}/hairball/groundtruth.exr" "${source_dir}/hairball/hairball_ic_002"
done
mv "${source_dir}/hairball/timings" "${source_dir}/hairball/timings_ic_002"
mv "${source_dir}/hairball/samplerates" "${source_dir}/hairball/samplerates_ic_002"

for i in {1..5}
do
	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=5 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=2000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0.01
	python3 "${source_dir}/../compare_err.py" "${source_dir}/hairball/hairball.exr" "${source_dir}/hairball/groundtruth.exr" "${source_dir}/hairball/hairball_ic_001"
done
mv "${source_dir}/hairball/timings" "${source_dir}/hairball/timings_ic_001"
mv "${source_dir}/hairball/samplerates" "${source_dir}/hairball/samplerates_ic_001"

for i in {1..5}
do
	mitsuba "${source_dir}/hairball/hairball.xml" -Dcstrat=5 -Dsamplerate=1 -Dcompcstrat=ls -Dcps=4000 -Dsps=10 -Dspp=4 -Dslice=5000 -Dis=1 -Dbv=1 -Dvp=0.025 -Diet=0.005
	python3 "${source_dir}/../compare_err.py" "${source_dir}/hairball/hairball.exr" "${source_dir}/hairball/groundtruth.exr" "${source_dir}/hairball/hairball_ic_0005"
done
mv "${source_dir}/hairball/timings" "${source_dir}/hairball/timings_ic_0005"
mv "${source_dir}/hairball/samplerates" "${source_dir}/hairball/samplerates_ic_0005"